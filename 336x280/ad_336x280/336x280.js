...
(lib._336x280 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(116).to({_off:false},0).wait(1).to({regX:150.4,regY:18,x:127.9,y:756.95},0).wait(1).to({y:755.15},0).wait(1).to({y:751.9},0).wait(1).to({y:746.8},0).wait(1).to({y:739.55},0).wait(1).to({y:729.45},0).wait(1).to({y:715.6},0).wait(1).to({y:696.55},0).wait(1).to({y:669.7},0).wait(1).to({y:629.85},0).wait(1).to({y:565.55},0).wait(1).to({y:461.25},0).wait(1).to({y:362.55},0).wait(1).to({y:302.3},0).wait(1).to({y:263.7},0).wait(1).to({regX:68.2,regY:42.8,x:83.25,y:250.35},0).wait(1).to({regX:150.4,regY:18,x:127.85,y:230.8,alpha:0.2857},0).wait(1).to({y:226.25,alpha:0.4987},0).wait(1).to({y:222.85,alpha:0.659},0).wait(1).to({y:220.3,alpha:0.779},0).wait(1).to({y:218.4,alpha:0.8671},0).wait(1).to({y:217.05,alpha:0.9294},0).wait(1).to({y:216.2,alpha:0.9703},0).wait(1).to({y:215.7,alpha:0.9929},0).wait(1).to({regX:68.2,regY:42.7,x:83.25,y:229.05,alpha:1},0).wait(184).to({regY:42.8,y:313.35,alpha:0},8,cjs.Ease.quartInOut).to({y:439.05},22,cjs.Ease.quartInOut).to({_off:true},1).wait(65));

	// primary_cta
	this.instance_7 = new lib.primary_cta();
	this.instance_7.setTransform(168,500.85,0.8332,0.8331,0,0,0,72,17.2);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;
	new cjs.ButtonHelper(this.instance_7, 0, 1, 2, false, new lib.primary_cta(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(151).to({_off:false},0).wait(1).to({regX:72.5,regY:-111.1,x:168.4,y:392.95},0).wait(1).to({y:391.3},0).wait(1).to({y:388.8},0).wait(1).to({y:385.4},0).wait(1).to({y:380.85},0).wait(1).to({y:374.85},0).wait(1).to({y:367.2},0).wait(1).to({y:357.35},0).wait(1).to({y:344.7},0).wait(1).to({y:328.55},0).wait(1).to({y:308.15},0).wait(1).to({y:283.8},0).wait(1).to({y:257.7},0).wait(1).to({y:233.65},0).wait(1).to({y:213.85},0).wait(1).to({y:198.35},0).wait(1).to({y:186.45},0).wait(1).to({y:177.3},0).wait(1).to({regX:72,regY:17.1,x:168,y:277.3},0).wait(1).to({regX:72.5,regY:-111.1,x:168.4,y:160.75,alpha:0.3518},0).wait(1).to({y:153.6,alpha:0.6106},0).wait(1).to({y:148.5,alpha:0.7935},0).wait(1).to({y:145.2,alpha:0.9131},0).wait(1).to({y:143.35,alpha:0.9794},0).wait(1).to({regX:72,regY:17.2,x:168,y:249.6,alpha:1},0).wait(145).to({regX:72.5,regY:-111.1,x:168.4,y:145.1,alpha:0.9487},0).wait(1).to({y:149.3,alpha:0.8612},0).wait(1).to({y:155.45,alpha:0.7315},0).wait(1).to({y:164.05,alpha:0.5519},0).wait(1).to({y:175.45,alpha:0.3124},0).wait(1).to({regX:72,regY:17.2,x:168,y:297.3,alpha:0},0).wait(1).to({regX:72.5,regY:-111.1,x:168.4,y:197.5},0).wait(1).to({y:206.65},0).wait(1).to({y:218.35},0).wait(1).to({y:233.35},0).wait(1).to({y:252.3},0).wait(1).to({y:274.9},0).wait(1).to({y:299.1},0).wait(1).to({y:321.45},0).wait(1).to({y:339.85},0).wait(1).to({y:354.2},0).wait(1).to({y:365.3},0).wait(1).to({y:373.75},0).wait(1).to({y:380.15},0).wait(1).to({y:385},0).wait(1).to({y:388.55},0).wait(1).to({y:391.1},0).wait(1).to({y:392.75},0).wait(1).to({y:393.65},0).wait(1).to({regX:72,regY:17.2,x:168,y:500.85},0).wait(76));
...
p.nominalBounds = new cjs.Rectangle(168,-140,168.10000000000002,904);
// library properties:
lib.properties = {
